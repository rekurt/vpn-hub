...
export const landingData: Record<LandingLocale, LandingCopy> = {
  en: {
    ...
    useCases: {
      ...
      items: [
        { title: 'Split tunnel by destination', category: 'Routing', summary: 'Keep corp, private, and public traffic separate with per-tunnel DNS and namespace policy.', commandHint: 'hubctl routes add 203.0.113.0/24 corp-egress' },
        ...
        { title: 'Provider migration with rollback', category: 'Availability', summary: 'Dry-run subscriptions, test canary candidates, and rollback if health checks fail.', commandHint: 'hubctl subscription refresh corp-egress --timeout 20m' },
        ...
        { title: 'Private DNS and DNS zone split', category: 'Networking', summary: 'Private names follow tunnel DNS policy, public names keep normal resolver behavior.', commandHint: 'hubctl config set hub.dns.search "corp.example.com"' },
        ...
        { title: 'Drift correction', category: 'Compliance', summary: 'Detect live-rule drift and re-apply controlled policy from declared state.', commandHint: 'hubctl verify && hubctl deploy' },
  ...
  ru: {
    ...
    useCases: {
      ...
      items: [
        { title: 'Раздельная маршрутизация', category: 'Сеть', summary: 'Отдельные пути для рабочей сети, частных адресов и общего интернета.', commandHint: 'hubctl routes add 203.0.113.0/24 corp-egress' },
        ...
        { title: 'Миграция провайдера с откатом', category: 'Доступность', summary: 'Кандидатный upstream проходит canary, затем промоушн или rollback.', commandHint: 'hubctl subscription refresh corp-egress --timeout 20m' },
        ...
        { title: 'Private DNS', category: 'Сеть', summary: 'Частные зоны работают в привязанном tunnel, публичные без перехвата.', commandHint: 'hubctl config set hub.dns.search "corp.example.com"' },
        ...
        { title: 'Проверка дрейфа', category: 'Контроль', summary: 'Сверка реального состояния и декларативного плана с восстановлением.', commandHint: 'hubctl verify && hubctl deploy' },
  ...
  'zh-cn': {
    ...
    useCases: {
      ...
      heading: '支持的使用场景',
      items: [
        { title: '按目的地址分流', category: '网络', summary: '将企业流量、私有网段与公共访问按目的分配到不同 egress。', commandHint: 'hubctl routes add 203.0.113.0/24 corp-egress' },
        ...
        { title: '供应商迁移与回滚', category: '可用性', summary: '候选源先走 canary 验证，再进行切换或回滚。', commandHint: 'hubctl subscription refresh corp-egress --timeout 20m' },
        ...
        { title: '私有 DNS 划分', category: '网络', summary: '私有域名在隧道内解析，公共流量保持正常解析策略。', commandHint: 'hubctl config set hub.dns.search "corp.example.com"' },
        ...
        { title: '漂移检测', category: '合规', summary: '对照 live 状态与声明状态并修复偏差。', commandHint: 'hubctl verify && hubctl deploy' },
